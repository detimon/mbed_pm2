...
// +==============================================================+
// | Datei      : test_linefollower_bwd.cpp
// | Komponente : Linefollower (rueckwaerts)
// | BMK        : B1
// | Pin(s)     : I2C1: SDA=PB_9, SCL=PB_8
// +--------------------------------------------------------------+
// | TESTZIEL   : Linienfolge bei Rueckwaertsfahrt.
// | VORAUSSETZ.: test_linefollower laeuft.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Roboter folgt Linie kontrolliert rueckwaerts ohne abrupten Lenkausschlag.
// +--------------------------------------------------------------+
...
#ifdef TEST_LINEFOLLOWER_BWD

#include "test_linefollower_bwd.h"
