...
// +==============================================================+
// | Datei      : test_neopixel_color.cpp
// | Komponente : NeoPixel + Farbsensor Live-Validierung
// | BMK        : P1 + B4
// | Pin(s)     : NeoPixel: PC_5; Farbsensor: siehe test_color_detect
// +--------------------------------------------------------------+
// | TESTZIEL   : Farbsensor-Klassifikation wird live auf NeoPixel gespiegelt.
// | VORAUSSETZ.: test_neopixel_basic + test_color_detect erfolgreich.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Erkannte Farbe leuchtet sofort auf NeoPixel, Reaktion <100 ms.
// +--------------------------------------------------------------+
