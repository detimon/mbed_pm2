...
// +==============================================================+
// | Datei      : test_linefollower_fast.cpp
// | Komponente : Linefollower (schnell)
// | BMK        : B1
// | Pin(s)     : I2C1: SDA=PB_9, SCL=PB_8
// +--------------------------------------------------------------+
// | TESTZIEL   : Linienerkennung bei voller Fahrgeschwindigkeit (Wettkampf-Setting).
// | VORAUSSETZ.: test_linefollower stabil; Roboter mechanisch ausgewuchtet.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Roboter folgt Linie ohne Ausbruch. STABIL — Parameter NICHT veraendern (CLAUDE.md).
// +--------------------------------------------------------------+
...
#include "test_linefollower_fast.h"
