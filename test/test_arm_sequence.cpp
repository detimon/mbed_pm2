...
// +==============================================================+
// | Datei      : test_arm_sequence.cpp
// | Komponente : Arm-Isolationstest 10-Schritt-Sequenz
// | BMK        : M20 + M21 + M22
// | Pin(s)     : PB_D0=PB_2, PB_D1=PC_8, PB_D3=PB_12
// +--------------------------------------------------------------+
// | TESTZIEL   : Vollstaendige Pick-and-Place-Sequenz inkl. Karussel-Drehung verifizieren.
// | VORAUSSETZ.: test_arm_logic erfolgreich, Endschalter 360-Grad-Servo entfernt (Konzept geaendert).
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   10 Schritte werden in <30 s sequentiell abgearbeitet, Button 2 stoppt jederzeit.
// +--------------------------------------------------------------+
