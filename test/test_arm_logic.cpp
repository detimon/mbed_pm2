...
// +==============================================================+
// | Datei      : test_arm_logic.cpp
// | Komponente : Arm-Logik Standard-Sequenz
// | BMK        : M20 + M21
// | Pin(s)     : PB_D0 = PB_2, PB_D1 = PC_8
// +--------------------------------------------------------------+
// | TESTZIEL   : Logische Greif- und Ablage-Sequenz des Arms durchspielen.
// | VORAUSSETZ.: test_servo_combined erfolgreich, Tray korrekt montiert.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Arm faehrt nacheinander Heim - greifen - ablegen - Heim. Keine Kollision.
// +--------------------------------------------------------------+
...
#ifdef TEST_ARM_LOGIC

#include "test_arm_logic.h"
#include "Servo.h"
