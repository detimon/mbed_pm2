...
// +==============================================================+
// | Datei      : calib_color_hue.cpp
// | Komponente : TCS3200 Farbsensor Hue-Schwellwerte
// | BMK        : B4
// | Pin(s)     : OUT=PB_3, LED=PC_3, S0=PA_1, S1=PA_4, S2=PC_1, S3=PC_0
// +--------------------------------------------------------------+
// | TESTZIEL   : Hue-Grenzen fuer ROT/GELB/GRUEN/BLAU im Live-Refresh-Display bestimmen.
// | VORAUSSETZ.: Sensor in Halterung montiert, weisser Untergrund fuer Weissabgleich.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Avg-Hz Werte stabil; Hue-Wert pro Farbkarte notieren und in calibration_values.h eintragen.
// +--------------------------------------------------------------+
...
// Refresh constants — see calibration_values.h (HUE_DISPLAY_LINES / HUE_PRINT_EVERY_N)
...
{
    m_print_counter++;
    if (m_print_counter < HUE_PRINT_EVERY_N)
        return;
    m_print_counter = 0;

    if (!m_first_print)
        printf("\033[%dA", HUE_DISPLAY_LINES);
    m_first_print = false;
    ...
    // ---- HUE_DISPLAY_LINES = 10 lines below ----
    ...
    printf(ANSI_CYAN "====================================================" ANSI_RESET ANSI_ERASE "\n");
    // ---- end of HUE_DISPLAY_LINES = 10 lines ----
}
