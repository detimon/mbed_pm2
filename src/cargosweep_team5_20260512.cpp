...
static int   m_tray_wait_ctr       = 0;     // Wartezeit auf Tray-Positionierung
...
static int   m_reverse_ctr         = 0;     // ROT/GELB Rückfahrt-Loop-Zähler
...
//
// Führt die 5-phasige Ablagesequenz aus. Wird einmal pro Loop aufgerufen.
...
void cargosweep_team5_20260512_print()
{
    ...
    printf("State: %s ph=%d dr=%d lc=%d | tray=%.1f/%.1f | col=%-5s act=%-5s\n",
           s,
           m_deliver_phase,
           m_forward_ctr,
           m_line_count,
...
#endif // CARGOSWEEP_TEAM5_20260512
