...
// +==============================================================+
// | Datei      : test_linefollower_slow.cpp
// | Komponente : Linefollower (langsam)
// | BMK        : B1
...
// |   Roboter folgt Linie langsam, ideal zum Pruefen der Sensor-Klassifikation.
// +--------------------------------------------------------------+
...
#include "test_linefollower_slow.h"
