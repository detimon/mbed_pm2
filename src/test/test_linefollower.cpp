...
// +==============================================================+
// | Datei      : test_linefollower.cpp
// | Komponente : Linefollower SparkFun SEN-13582
// | BMK        : B1
// | Pin(s)     : I2C1: SDA=PB_9, SCL=PB_8
// +--------------------------------------------------------------+
// | TESTZIEL   : Linienerkennung in Standard-Geschwindigkeit.
// | VORAUSSETZ.: Motorentests bestanden, Sensorbalken mittig montiert.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Roboter folgt schwarzer Linie, korrigiert leicht in Kurven.
// +--------------------------------------------------------------+
