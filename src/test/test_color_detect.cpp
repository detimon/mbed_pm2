...
// +==============================================================+
// | Datei      : test_color_detect.cpp
// | Komponente : TCS3200 Farbsensor (Klassifikation)
// | BMK        : B4
// | Pin(s)     : OUT=PB_3, LED=PC_3, S0=PA_1, S1=PA_4, S2=PC_1, S3=PC_0
// +--------------------------------------------------------------+
// | TESTZIEL   : Farbsensor klassifiziert ROT/GELB/GRUEN/BLAU korrekt.
// | VORAUSSETZ.: calib_color_hue abgeschlossen, Hue-Grenzen in lib/ColorSensor aktuell.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Bei Vorhalten einer Farbkarte erscheint der korrekte Farbname auf Serial.
// +--------------------------------------------------------------+
...
#define DISPLAY_LINES 8              // number of lines printed — must stay in sync with color_detect_print()
