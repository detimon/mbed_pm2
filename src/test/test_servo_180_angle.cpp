...
// +==============================================================+
// | Datei      : test_servo_180_angle.cpp
// | Komponente : 180-Grad-Servo Winkel-Verifikation
// | BMK        : M20 / M21
// | Pin(s)     : PB_D1 = PC_8 / PB_D0 = PB_2
// +--------------------------------------------------------------+
// | TESTZIEL   : Winkelposition gegen mechanische Markierung verifizieren.
// | VORAUSSETZ.: test_servo_180 erfolgreich.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Servo faehrt 90 Grad an. Mechanische Markierung steht in Mittellage.
// +--------------------------------------------------------------+
...
#ifdef TEST_SERVO_180_ANGLE

#include "test_servo_180_angle.h"
#include "Servo.h"
