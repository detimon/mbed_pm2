...
// +==============================================================+
// | Datei      : test_motor_drive.cpp
// | Komponente : DC-Motoren M10 (rechts) + M11 (links)
// | BMK        : M10 / M11
// | Pin(s)     : PWM PB13/PA9, ENC PA6/PC7 + PB6/PB7, EN PB15
// +--------------------------------------------------------------+
// | TESTZIEL   : Beide Motoren durchlaufen 5-Phasen-Sequenz: Rampe hoch, halten, runter, rueckwaerts, Stop.
// | VORAUSSETZ.: Akku angeschlossen, ST-Link verbunden, Roboter aufgebockt (Raeder frei).
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Phasenwechsel alle 2 s, |v| <= 1.5 RPS. Ist/Soll-Vergleich auf Serial Monitor.
// +--------------------------------------------------------------+
...
#ifdef TEST_MOTOR_DRIVE

#include "test_motor_drive.h"
#include "DCMotor.h"
