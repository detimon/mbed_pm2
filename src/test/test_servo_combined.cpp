...
// +==============================================================+
// | Datei      : test_servo_combined.cpp
// | Komponente : Servos kombiniert (M20 + M21 + M22)
// | BMK        : M20 / M21 / M22
// | Pin(s)     : PB_D0=PB_2, PB_D1=PC_8, PB_D3=PB_12
// +--------------------------------------------------------------+
// | TESTZIEL   : Alle drei Servos zusammen ansteuern und Cross-Talk ausschliessen.
// | VORAUSSETZ.: Einzeltests (test_servo_180, calib_servo_360) erfolgreich.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Jeder Servo erreicht seine Zielposition unabhaengig, keine PWM-Interferenz.
// +--------------------------------------------------------------+
