...
// +==============================================================+
// | Datei      : test_system_all.cpp
// | Komponente : Systemintegration (alle Module)
// | BMK        : —
// | Pin(s)     : siehe Verdrahtungstabelle
// +--------------------------------------------------------------+
// | TESTZIEL   : Vollstaendige LineXpress-Mission durchspielen (Integrationstest).
// | VORAUSSETZ.: Alle Einzeltests gruen, Akku >50%.
// +--------------------------------------------------------------+
// | ERWARTETES VERHALTEN:
// |   Roboter loest komplette Aufgabe selbststaendig: Start - Linie - Stops - Ablage - Ende.
// +--------------------------------------------------------------+
...
#ifdef TEST_SYSTEM_ALL

#include "test_system_all.h"
