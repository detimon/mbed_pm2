// CargoSweep — PROTOTYPE_03_V32_02
// Kopie von v31_1. Einzige Änderung: runPickupPhase() in STATE_CROSSING_STOP
// und STATE_ROT_GELB_PAUSE durch runDeliverPhase() ersetzt.
#include "test_config.h"

#ifdef PROTOTYPE_03_V32_02
...
// ---------------------------------------------------------------------------
// Ablege-Sequenz (runDeliverPhase) — wird jetzt ÜBERALL verwendet
...
void roboter_v32_02_task(DigitalOut& led)
{
    ...
    *g_en = 1;
    ...
    switch (m_state) {
        ...
        // ----------------------------------------------------------------
        // CROSSING_STOP — jetzt runDeliverPhase() statt runPickupPhase()
        // ----------------------------------------------------------------
        case STATE_CROSSING_STOP: {
            ...
            if (m_arm_retract_ctr == 1) {
                if (runDeliverPhase()) {   // <-- v32_02: deliver statt pickup
                    m_arm_retract_ctr = 0;
                    advanceTray();
                }
            }
        ...
        // ----------------------------------------------------------------
        // ROT_GELB_PAUSE — jetzt runDeliverPhase() statt runPickupPhase()
        // ----------------------------------------------------------------
